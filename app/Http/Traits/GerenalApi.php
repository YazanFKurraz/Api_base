...
trait GerenalApi
{
    ...
    //note must be unite method error and success the way is best like:-

    // style return response json in postman
    ...
    // style return error response
    public function errorMessage($message = 'Error try again', $number = 400 )
    {
        return response()->json([
            'status' => false,
            'number' => $number,
    ...
    public function successMessage($message = 'success', $number = 200)
    {
        return response()->json([
            'status' => true,
            'number' => $number,
...
/*
    public function sendResponse($key, $value, $number = 200, $message = 'success')
    {
        return response()->json([
            'status' => true,
            'number' => $number,
...
*/
    ...
    {
        return $this->errorMessage($code, $validator->errors()->first());
    }
